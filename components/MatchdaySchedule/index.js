...
const MatchdaySchedule = ({ matchday, matches, changeMatchday }) => {
    ...
    return (
        <Fragment>
            ...
            <ScheduleContainer>
                {matches.map(match => {
                    let date = new Date(match.utcDate).toLocaleDateString(
                        undefined,
                        {
                            weekday: 'long',
                            month: 'long',
                    ...
                    return (
                        <Fragment key={match.id}>
                            ...
                            <MatchContainer>
                                <HomeTeam>
                                    <span>
                                        {teamsMap[match.homeTeam.id]['short']}
                                    </span>
                                    <img
                                        src={
                                            teamsMap[match.homeTeam.id][
                                                'crestURL'
                                            ]
                                        }
                                    />
                                ...
                                <AwayTeam>
                                    <img
                                        src={
                                            teamsMap[match.awayTeam.id][
                                                'crestURL'
                                            ]
                                        }
                                    />
                                    <span>
                                        {teamsMap[match.awayTeam.id]['short']}
                                    </span>
                                </AwayTeam>
                            </MatchContainer>
                        </Fragment>
